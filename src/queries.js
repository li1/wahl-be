...
'   UNION ALL',
'   select wz.legislaturperiodeid, w.name, \'n.a.\',we.anz, we.anteil, wz.anz, wz.anteil, p.name',
'   from  Wahlkreiserststimmenergebnisse we, Wahlkreiszweitstimmenergebnisse wz, Wahlkreise w, Kandidaten k,  Parteien p',
